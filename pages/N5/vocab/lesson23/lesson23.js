...
const lessonVocab = [
   {
    ...
    romaji: "oyu",
    meaning: "Nước nóng",
    example: "右へ回すと、お湯が出ます。",
    exampleKana: "みぎへ まわすと、おゆが でます。",
    exampleMeaning: "Vặn về bên phải, nước nóng sẽ chảy ra."
  },
  {
    kana: "みち",
    kanji: "道",
    romaji: "michi",
    meaning: "Đường",
    example: "この道をまっすぐ行くと、郵便局があります。",
    exampleKana: "この みちを まっすぐ いくと、ゆうびんきょくが あります。",
    exampleMeaning: "Đi thẳng đường này sẽ có bưu điện."
  },
  {
    kana: "こうさてん",
    kanji: "交差点",
    ...
    meaning: "Ngã tư",
    example: "交差点を渡ります。",
    exampleKana: "こうさてんを わたります。",
    exampleMeaning: "Băng qua ngã tư."
  },
  {
    kana: "しんごう",
    kanji: "信号",
    ...
    example: "信号を待ちます。",
    exampleKana: "しんごうを まちます。",
    exampleMeaning: "Chờ đèn giao thông."
  },
  {
    kana: "かど",
    kanji: "角",
    ...
    meaning: "Góc",
    example: "その角を左へ曲がります。",
    exampleKana: "そのかどを ひだりへ まがります。",
    exampleMeaning: "Rẽ trái ở góc đó."
  },
  {
    kana: "はし",
    kanji: "橋",
    ...
    meaning: "Cầu",
    example: "橋を渡ります。",
    exampleKana: "はしを わたります。",
    exampleMeaning: "Qua cầu."
  },
  {
    kana: "ちゅうしゃじょう",
    kanji: "駐車場",
    romaji: "chuushajou",
    meaning: "Bãi đỗ xe",
    example: "あそこで駐車場があります。",
    exampleKana: "あそこで ちゅうしゃじょうが あります。",
    exampleMeaning: "Đằng kia có bãi đỗ xe."
  },
  {
    kana: "たてもの",
    kanji: "建物",
    ...
    meaning: "Tòa nhà",
    example: "あの建物は新しいです。",
    exampleKana: "あの たてものは あたらしいです。",
    exampleMeaning: "Tòa nhà kia mới."
  }
];
...
const lessonTable = [
{
    ...
    romaji: "kikimasu",
    meaning: "Hỏi",
    example: "漢字なら、田中先生に聞いてください。",
    exampleKana: "かんじならたなかせんせいに きいてください。",
    exampleMeaning: "Nếu là kanji thì hãy hỏi thầy TANAKA."
  },
  {
    kana: "まわします",
    kanji: "回します",
  ...
  },
  {
    ...
    meaning: "Kéo",
    example: "ドアを引いて開けます。",
    exampleKana: "ドアを ひいてあけます。",
    exampleMeaning: "Kéo để mở cửa."
  },
  {
    kana: "さわります",
    kanji: "触ります",
    romaji: "sawarimasu",
    meaning: "Sờ, chạm vào",
    example: "暑いから、触らないでください",
    exampleKana: "あついから、さわらないで ください。",
    exampleMeaning: "Còn nóng, đừng chạm vào"
  },
  {
    kana: "でます",
    kanji: "出ます",
    ...
    example: "お釣りが出ます。",
    exampleKana: "おつりが でます。",
    exampleMeaning: "Tiền thừa được trả ra."
  },
  {
    kana: "でかけます",
    kanji: "出かけます",
    ...
    meaning: "Ra ngoài",
    example: "友達と出かけます。",
    exampleKana: "ともだちと でかけます。",
    exampleMeaning: "Tôi ra ngoài cùng bạn."
  },
  {
    kana: "わたります",
    kanji: "渡ります",
  ...
  },
  {
    ...
    meaning: "Rẽ, quẹo",
    example: "右へ曲がります。",
    exampleKana: "みぎへ まがります。",
    exampleMeaning: "Rẽ phải."
  },
  {
    kana: "しつれいします",
    kanji: "失礼します",
