...
function createExtraTableHTML(extraTable) {
    ...
    // Nếu chỉ có 1 bảng → chuyển thành mảng 1 phần tử
    // Nếu đã là nhiều bảng → giữ nguyên
    const tables = Array.isArray(extraTable)
        ? extraTable
        : [extraTable];
    ...
    return tables
        .map((table) => {
            ...
            return `
                <div class="grammar-extra-table-block">
                        ...
                        table.title
                            ? `
                                <h3 class="grammar-detail-section-title">
                                    ...
                                    <span class="grammar-extra-table-title">
                                        ${renderJapaneseText(
                                            table.title
                                        )}
                                    </span>
                                                            ...
                                                            headerAudio
                                                                ? `
                                                                    <button
                                                                        ...
                                                                        aria-label="Phát âm thanh ${escapeHTML(
                                                                            headerText
                                                                        )}"
                                                                        title="Nghe cách đọc"
                                                                    >
            ...
            return `
                <div class="grammar-example-pair">
                    ...
                    <div class="grammar-example-item">
                        ...
                        <div
                            class="
                                grammar-example-main
                                grammar-example-main-question
                            "
                        >
...
function normalizePracticeAnswer(value) {
    return String(value || "")
        ...
        // Không phân biệt hoa/thường Latin
        .toLowerCase()
